...
namespace API.Controllers
{
    public class AdminController : BaseApiController
    {
        ...
        public AdminController(UserManager<AppUser> userManager, IPhotoService photoRepository, IUnitOfWork unitOfWork)
        {
            _userManager = userManager;
            _photoService = photoRepository;
        ...
        //{
        //    return Ok("admins and moderators can see");
        //}
